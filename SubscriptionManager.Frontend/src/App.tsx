...
import { LandingPage, PrivacyPolicy, Terms, BookDemo, SolutionsPage, IndustriesPage, AboutPage, ProductsPage, MyQCareProductPage } from "./features/landing";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<MarketingLayout><Outlet /></MarketingLayout>}>
            ...
            <Route path="/products/myqcare" element={<MyQCareProductPage />} />
