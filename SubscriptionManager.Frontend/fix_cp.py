...
import { Search, Command, AppWindow, Building, ListTodo, Users, Tag, Settings } from 'lucide-react';
...
export const CommandPalette: React.FC<CommandPaletteProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[15vh]">
      ...
      <div className="relative w-full max-w-lg bg-white rounded-xl shadow-2xl overflow-hidden border border-[#E3E8EE] animate-in fade-in zoom-in-95 duration-200">
